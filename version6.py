...
def reward_function(params):
    ...
    next_point = waypoints[max(params["closest_waypoints"][1] + 2, len(waypoints) - 1)]
    prev_point = waypoints[params["closest_waypoints"][0]]

    if params["closest_waypoints"][1] < 5 and params["steering_angle"] > 2.0:
        return 1e-3
